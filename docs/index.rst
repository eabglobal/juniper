...
also use it to update a lambda function directly using the cli:
    ...
    >>> aws lambda update-function-code --function-name ThumbnailFn --zip-file ./dist/thumbnail.zip
...
* Easy way to define what to include in the zip artifact of a lambda function
